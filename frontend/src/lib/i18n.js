export const translations = {
  es: {
    ...
    scan: {
      ...
      scanDate: 'Escanear fecha',
      scanningDate: 'Leyendo fecha…',
      dateFound: 'Fecha detectada',
      dateNotFound: 'No se detectó la fecha — escribila a mano',
      batchMode: 'Modo lote',
      batchHint: 'Escaneá varios seguidos',
      batchCount: (n) => `${n} en cola`,
      batchSaveAll: (n) => `Guardar ${n}`,
      batchAdded: 'En cola',
    },
    hh: {
      title: 'Hogar',
  ...
  de: {
    ...
    scan: {
      ...
      scanDate: 'Datum scannen',
      scanningDate: 'Datum wird gelesen…',
      dateFound: 'Datum erkannt',
      dateNotFound: 'Datum nicht erkannt — bitte manuell eingeben',
      batchMode: 'Stapel-Modus',
      batchHint: 'Mehrere nacheinander scannen',
      batchCount: (n) => `${n} in Warteschlange`,
      batchSaveAll: (n) => `${n} speichern`,
      batchAdded: 'In Warteschlange',
    },
    hh: {
      title: 'Haushalt',
  ...
  en: {
    ...
    scan: {
      ...
      scanDate: 'Scan date',
      scanningDate: 'Reading date…',
      dateFound: 'Date detected',
      dateNotFound: 'No date detected — type it manually',
      batchMode: 'Batch mode',
      batchHint: 'Scan several in a row',
      batchCount: (n) => `${n} queued`,
      batchSaveAll: (n) => `Save ${n}`,
      batchAdded: 'Queued',
    },
    hh: {
      title: 'Household',
